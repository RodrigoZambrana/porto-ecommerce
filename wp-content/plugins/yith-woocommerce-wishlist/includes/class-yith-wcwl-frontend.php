...
if (!class_exists('YITH_WCWL_Frontend')) {
    ...
    class YITH_WCWL_Frontend
    {
        ...
        public function __construct()
        {
            ...
            add_filter('option_yith_wcwl_add_to_wishlist_icon', [
                $this,
                'update_font_awesome_classes',
            ]);
            add_filter('option_yith_wcwl_add_to_cart_icon', [
                $this,
                'update_font_awesome_classes',
            ]);
            ...
            add_filter('body_class', [$this, 'add_body_class'], 90);
            add_action('template_redirect', [$this, 'add_nocache_headers']);
            add_action('wp_head', [$this, 'add_noindex_header']);
            add_filter('wp_robots', [$this, 'add_noindex_robots']);
            add_action('yith_wcwl_before_wishlist_title', [
                $this,
                'print_notices',
            ]);
            add_action(
                'yith_wcwl_wishlist_before_wishlist_content',
                [$this, 'wishlist_header'],
                10,
                1
            );
            add_action(
                'yith_wcwl_wishlist_main_wishlist_content',
                [$this, 'main_wishlist_content'],
                10,
                1
            );
            add_action(
                'yith_wcwl_wishlist_after_wishlist_content',
                [$this, 'wishlist_footer'],
                10,
                1
            );
            ...
            add_filter(
                'post_class',
                [$this, 'add_products_class_on_loop'],
                20,
                3
            );

            // scripts.
            add_action('wp_head', [$this, 'detect_javascript'], 0);
            add_action('wp_enqueue_scripts', [
                $this,
                'enqueue_styles_and_stuffs',
            ]);

            // add YITH WooCommerce Frequently Bought Together Premium shortcode.
            add_action(
                'yith_wcwl_after_wishlist_form',
                [$this, 'yith_wcfbt_shortcode'],
                10,
                1
            );
            add_filter(
                'woocommerce_add_to_cart_redirect',
                [$this, 'yith_wfbt_redirect_after_add_to_cart'],
                10,
                1
            );
        ...
        public function add_button()
        {
            ...
            add_filter(
                ...
                [$this, 'add_button_for_blocks_product_grid_item'],
                10,
                3
            );
        }
        ...
        public function add_button_for_single()
        {
             ...
             * @return array
             */
            $positions = apply_filters('yith_wcwl_positions', [
                'after_add_to_cart' => [
            ...
            if (yith_plugin_fw_wc_is_using_block_template_in_single_product()) {
                $this->add_button_for_blockified_template(
                    'single-product',
                    $position
                );
            } else {
        ...
        public function add_button_for_loop()
        {
            ...
            $enabled_on_loop =
                'yes' === get_option('yith_wcwl_show_on_loop', 'no');
             ...
             * @return array
             */
            $positions = apply_filters('yith_wcwl_loop_positions', [
                'before_image' => [
            ...
            if (
                yith_plugin_fw_wc_is_using_block_template_in_product_catalogue()
            ) {
                $this->add_button_for_blockified_template(
                    'archive-product',
                    $position
        ...
        public function add_button_for_blockified_template($template, $position)
        {
            switch ($position) {
                ...
                case 'after_add_to_cart':
                    $block =
                        'single-product' === $template
                            ...
                            : 'product-button';
                    add_filter(
                        "render_block_woocommerce/$block",
                        [$this, 'add_button_after_block'],
                        10,
                        3
                    );
                    break;
                ...
                case 'summary':
                    add_filter(
                        'render_block_woocommerce/product-details',
                        [$this, 'add_button_after_block'],
                        10,
                        3
                    );
         ...
         */
        public function add_button_before_block(
            $block_content,
            $parsed_block,
            $block
        ) {
         ...
         * @return string Filtered block content.
         */
        public function add_button_after_block(
            $block_content,
            $parsed_block,
            $block
        ) {
         ...
         */
        public function add_button_for_blocks_product_grid_item(
            $item_html,
            $data,
            $product
        ) {
            ...
            if ($index) {
                ...
                $parts = array_merge($first_set, (array) $button, $second_set);

                // replace li classes.
                $parts[0] = preg_replace(
                    '/class="(.*)"/',
                    'class="$1 add-to-wishlist-' . $position . '"',
                    $parts[0]
                );
            }
        ...
        public function add_noindex_header()
        {
            ...
            if (
                ...
                apply_filters('yith_wcwl_skip_noindex_headers', false)
            ) {
        ...
        public function register_styles()
        {
            ...
            $assets_path =
                str_replace(['http:', 'https:'], '', WC()->plugin_url()) .
                '/assets/';
            ...
            wp_register_style(
                ...
                YITH_WCWL_URL . 'assets/css/font-awesome.css',
                [],
                '4.7.0'
            );
            wp_register_style(
             ...
             * @return array
             */
            $deps = apply_filters('yith_wcwl_main_style_deps', [
                'jquery-selectBox',
                'yith-wcwl-font-awesome',
                'woocommerce_prettyPhoto_css',
            ]);
            ...
            if (!$located) {
                ...
                $style_url =
                    strpos($located, $stylesheet_directory) !== false
                        ? str_replace(
                ...
                if (
                    ...
                    wp_register_style(
                        ...
                        YITH_WCWL_URL .
                            ...
                            $theme_slug .
                            '.css',
                        [$located ? 'yith-wcwl-user-main' : 'yith-wcwl-main'],
                        $this->version
                    );
                }
            }
        ...
        public function register_scripts()
        {
            ...
            $prefix =
                defined('SCRIPT_DEBUG') && SCRIPT_DEBUG ? 'unminified/' : '';

            // register dependencies.
            wp_register_script(
                'prettyPhoto',
                $assets_path .
                    'js/prettyPhoto/jquery.prettyPhoto' .
                    $suffix .
                    '.js',
                ['jquery'],
                '3.1.6',
            ...
            wp_register_script(
                'jquery-selectBox',
                YITH_WCWL_URL . 'assets/js/jquery.selectBox.min.js',
                ['jquery'],
                '1.2.0',
                true
            );
             ...
             * @return array
             */
            $deps = apply_filters('yith_wcwl_main_script_deps', [
                'jquery',
                'jquery-selectBox',
                'prettyPhoto',
            ]);
        ...
        public function enqueue_custom_style()
        {
            ...
            if ($custom_css) {
                $handle = wp_script_is('yith-wcwl-user-main')
                    ? 'yith-wcwl-user-main'
                    : 'yith-wcwl-main';
        ...
        public function get_localize()
        {
             ...
             * @return array
             */
            return apply_filters('yith_wcwl_localize_script', [
                'ajax_url' => admin_url('admin-ajax.php', 'relative'),
                'redirect_to_cart' => get_option('yith_wcwl_redirect_cart'),
                'yith_wcwl_button_position' => get_option(
                 ...
                 * @return bool
                 */
                'hide_add_button' => apply_filters(
                    'yith_wcwl_hide_add_button',
                    true
                ),
                'enable_ajax_loading' =>
                    'yes' === get_option('yith_wcwl_ajax_enable', 'no'),
                'ajax_loader_url' =>
                    YITH_WCWL_URL . 'assets/images/ajax-loader-alt.svg',
                'remove_from_wishlist_after_add_to_cart' =>
                    'yes' === get_option('yith_wcwl_remove_after_add_to_cart'),
                /**
                 ...
                 * @return bool
                 */
                'is_wishlist_responsive' => apply_filters(
                    'yith_wcwl_is_wishlist_responsive',
                    true
                ),
                /**
                 ...
                 * @return int
                 */
                'time_to_close_prettyphoto' => apply_filters(
                    'yith_wcwl_time_to_close_prettyphoto',
                    3000
                ),
                /**
                 ...
                 * @return string
                 */
                'fragments_index_glue' => apply_filters(
                 ...
                 * @return bool
                 */
                'reload_on_found_variation' => apply_filters(
                    'yith_wcwl_reload_on_found_variation',
                    true
                ),
                /**
                 ...
                 * @return int
                 */
                'mobile_media_query' => apply_filters(
                    'yith_wcwl_mobile_media_query',
                    768
                ),
                'labels' => [
                    'cookie_disabled' => __(
                ...
                'nonce' => [
                    'add_to_wishlist_nonce' => wp_create_nonce(
                        'add_to_wishlist'
                    ),
                    'remove_from_wishlist_nonce' => wp_create_nonce(
                        'remove_from_wishlist'
                    ),
                    'reload_wishlist_and_adding_elem_nonce' => wp_create_nonce(
                        'reload_wishlist_and_adding_elem'
                    ),
                 ...
                 * @return bool
                 */
                'redirect_after_ask_estimate' => apply_filters(
                    'yith_wcwl_redirect_after_ask_an_estimate',
                    false
                ),
                /**
                 ...
                 * @return string
                 */
                'ask_estimate_redirect_url' => apply_filters(
                    'yith_wcwl_redirect_url_after_ask_an_estimate',
                    get_home_url()
                ),
            ]);
        }
        ...
        {
            // phpcs:ignore Universal.NamingConventions.NoReservedKeywordParameterNames.varFound
            $template = isset($var['template_part'])
                ? $var['template_part']
                : 'view';
         ...
         * @since 3.0.0
         */
        public function add_products_class_on_loop(
            $classes,
            $class = '',
            $post_id = 0
        ) {
        ...
        public function alter_add_to_cart_button()
        {
            add_filter('woocommerce_loop_add_to_cart_args', [
                $this,
                'alter_add_to_cart_args',
            ]);
            add_filter(
                'woocommerce_product_add_to_cart_text',
                [$this, 'alter_add_to_cart_text'],
                10,
                2
            );
            add_filter(
                'woocommerce_product_add_to_cart_url',
                [$this, 'alter_add_to_cart_url'],
                10,
                2
            );
        }
        ...
        {
            remove_filter('woocommerce_loop_add_to_cart_args', [
                $this,
                'alter_add_to_cart_args',
            ]);
            remove_filter('woocommerce_product_add_to_cart_text', [
                $this,
                'alter_add_to_cart_text',
            ]);
            remove_filter('woocommerce_product_add_to_cart_url', [
                $this,
                'alter_add_to_cart_url',
            ]);
        }
        ...
        {
            $label_option = get_option(
                'yith_wcwl_add_to_cart_text',
                __('Agregar al carrito', 'yith-woocommerce-wishlist')
            );
            ...
            $label = $product->is_type('variable')
                ? $text
                : apply_filters('yith_wcwl_add_to_cart_label', $label_option);
        ...
        public function alter_add_to_cart_url($url, $product)
        {
            ...
            if ($yith_wcwl_wishlist_token) {
                ...
                if (
                    ...
                    'yes' === get_option('yith_wcwl_redirect_cart')
                ) {
                    $url = add_query_arg(
                        'add-to-cart',
                        $product->get_id(),
            ...
            return apply_filters(
                'yit_wcwl_add_to_cart_redirect_url',
                esc_url_raw($url),
                $url,
                $product
            );
        ...
        {
            if (
                !(defined('YITH_WFBT') && YITH_WFBT) ||
                'no' === get_option('yith_wfbt_enable_integration') ||
                empty($meta)
            ) {
                return;
            }
        ...
        public function yith_wfbt_redirect_after_add_to_cart($url)
        {
            ...
            return 'yes' === get_option('yith_wcwl_redirect_cart')
                ? wc_get_cart_url()
                : YITH_WCWL()->get_wishlist_url();
        }
         ...
         */
        protected function build_custom_css($rules = [])
        {
            $generated_code = '';
                    ...
                    [
                        'color_add_to_wishlist' => [
                            ...
                            'rules' => [
                                'background' => [
                                    'rule' =>
                                        'background-color: %1$s; background: %1$s',
                                    'default' => '#333333',
                                ],
                                'text' => [
                                    'rule' => 'color: %s',
                        ...
                        'color_add_to_cart' => [
                            ...
                            'rules' => [
                                'background' => [
                                    'rule' =>
                                        'background: %1$s; background-color: %1$s;',
                                    'default' => '#333333',
                                ],
                                'text' => [
                                    'rule' => 'color: %s',
                        ...
                        'add_to_cart_rounded_corners_radius' => [
                            'selector' =>
                                '.woocommerce .wishlist_table a.add_to_cart.button.alt',
                            'rules' => [
                                'rule' => 'border-radius: %dpx',
            ...
            foreach ($rules as $id => $rule) {
                ...
                if (!empty($rule['deps'])) {
                    foreach ($rule['deps'] as $dep_rule => $dep_value) {
                        if (
                            !isset($dependencies[$dep_rule]) ||
                            $dependencies[$dep_rule] !== $dep_value
                        ) {
                            continue 2;
                        }
                    }
                ...
                if (isset($rule['rules']['rule'])) {
                    ...
                    $status = isset($rule['rules']['status'])
                        ? $rule['rules']['status']
                        : '';
                    ...
                    $new_rules[$status][] = $this->build_css_rule(
                        $rule['rules']['rule'],
                        $values,
                        $rule['rules']['default']
                    );
        ...
        protected function build_css_rule($rule, $value, $default = '')
        {
            ...
            $value =
                '0' === $value || (!empty($value) && !is_array($value))
                    ? $value
                    : $default;
        ...
        protected function destroy_serialized_cookies()
        {
            ...
            if (
                isset($_COOKIE[$name]) &&
                is_serialized(sanitize_text_field(wp_unslash($_COOKIE[$name])))
            ) {
                $_COOKIE[$name] = wp_json_encode([]);
...
{
    // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid, Universal.Files.SeparateFunctionsFromOO
